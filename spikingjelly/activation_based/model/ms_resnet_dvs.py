...
__all__ = ['MSResNet', 'ms_resnet18', 'ms_resnet34', 'ms_resnet50', 'ms_resnet101',
           'ms_resnet152', 'ms_resnext50_32x4d', 'ms_resnext101_32x8d',
           'ms_wide_resnet50_2', 'ms_wide_resnet101_2']
...
def ms_function(x: torch.Tensor, y: torch.Tensor, cnf: str):
    if cnf == 'ADD':
        return x + y
    elif cnf == 'AND':
        return x * y
...
class TDBN(nn.Module):
    ...
    def __init__(self, num_feature):
        ...
        self.bn = BatchNorm3d1(num_features=num_feature)

    def forward(self, input):
        y = input.transpose(0, 2).contiguous().transpose(0, 1).contiguous()    #T B C H W --> C B T H W
        y = self.bn(y)
...
class BasicBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out = ms_function(identity, out, self.cnf)
...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        out = ms_function(out, identity, self.cnf)
...
class MSResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # 用于cifar10dvs 的conv1改了，卷积核3，缩小倍率2×2，inchannel是2
        self.conv1 = layer.Conv2d(2, self.inplanes, kernel_size=3, stride=2, padding=1,
                                  bias=False)
...
# --------------------------------------------------------------------------------
    ...
    def _forward_impl(self, x):
        ...
        x = self.conv1(x)  #用于cifar10dvs 的conv1改了，卷积核3，缩小倍率2×2，inchannel是2
        x = self.bn1(x)
...
def _ms_resnet(arch, block, layers, pretrained, progress, cnf, spiking_neuron, **kwargs):
    model = MSResNet(block, layers, cnf=cnf, spiking_neuron=spiking_neuron, **kwargs)
    if pretrained:
...
def ms_resnet18(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    ...
    return _ms_resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnet34(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _ms_resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnet50(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _ms_resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnet101(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _ms_resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnet152(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    return _ms_resnet('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnext50_32x4d(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _ms_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_resnext101_32x8d(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _ms_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron,
                       **kwargs)


def ms_wide_resnet50_2(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    return _ms_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, spiking_neuron, **kwargs)


def ms_wide_resnet101_2(pretrained=False, progress=True, cnf: str = None, spiking_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    :param progress: If True, displays a progress bar of the download to stderr
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _ms_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, spiking_neuron,
                       **kwargs)
